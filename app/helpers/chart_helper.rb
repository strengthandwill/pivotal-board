...
module ChartHelper
  def chart(team, start, finish)
    ...
    LazyHighCharts::HighChart.new("graph") do |f|
      ...
      f.series(name: "Acceptance",  data: delivered(burndowns))
      f.series(name: "Testing",     data: finished(burndowns))
      f.series(name: "In Progress", data: started(burndowns))
      f.series(name: "To Do",       data: unstarted(burndowns))
