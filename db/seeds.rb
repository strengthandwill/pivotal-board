...
Account.create(name: 'Reach', path: 'reach', project_name: 'BGP-Phase-2', project_ids: '1963535')
Account.create(name: 'Meteor', path: 'meteor', project_name: 'BGP-Dev-WOG-Productivity', project_ids: '1784989')
Account.create(name: 'Constellation', path: 'constellation', project_name: 'BGP-General', project_ids: '1592917')
